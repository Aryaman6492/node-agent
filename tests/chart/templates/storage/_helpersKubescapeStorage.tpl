...
*/}}
{{- define "seclogic-storage.fullname" -}}
...
Common labels
*/}}
{{- define "seclogic-storage.labels" -}}
helm.sh/chart: {{ include "seclogic-storage.chart" . }}
{{ include "seclogic-storage.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "seclogic-storage.selectorLabels" -}}
app.kubernetes.io/name: {{ include "seclogic-storage.name" . }}
