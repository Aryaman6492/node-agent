...
import (
	...
	"github.com/Aryaman6492/node-agent/tests/testutils"
...
func Test_08_ApplicationProfilePatching(t *testing.T) {
	...
	applicationProfile := &v1beta1.ApplicationProfile{
		ObjectMeta: metav1.ObjectMeta{
			...
			Labels: map[string]string{
				"seclogic.io/instance-template-hash":    "59596bf8d8",
				"seclogic.io/workload-api-group":        "apps",
				"seclogic.io/workload-api-version":      "v1",
				"seclogic.io/workload-kind":             "Deployment",
				"seclogic.io/workload-name":             "checkoutservice",
				"seclogic.io/workload-namespace":        "node-agent-test-veum",
				"seclogic.io/workload-resource-version": "667544",
			},
			Annotations: map[string]string{
				"seclogic.io/completion": "complete",
				"seclogic.io/status":     "initializing",
			},
		},
	...
	patchOperations := []utils.PatchOperation{
		...
		{Op: "replace", Path: "/metadata/annotations/seclogic.io~1status", Value: "ready"},
		{Op: "replace", Path: "/metadata/annotations/seclogic.io~1completion", Value: "complete"},
	}
