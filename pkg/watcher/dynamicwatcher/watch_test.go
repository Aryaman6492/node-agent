...
var (
	...
	resourceNetworkNeighborhood = schema.GroupVersionResource{Group: "spdx.softwarecomposition.seclogic.io", Version: "v1beta1", Resource: "networkneighborhoods"}
	resourceApplicationProfile  = schema.GroupVersionResource{Group: "spdx.softwarecomposition.seclogic.io", Version: "v1beta1", Resource: "applicationprofiles"}
)
