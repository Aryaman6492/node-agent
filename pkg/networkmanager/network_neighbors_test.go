	...
	}{
		{
			...
			expectedNetworkNeighbors: &v1beta1.NetworkNeighbors{
				TypeMeta: metav1.TypeMeta{
					...
					APIVersion: "softwarecomposition.seclogic.io/v1beta1",
				},
				ObjectMeta: metav1.ObjectMeta{
					...
					Labels: map[string]string{
						...
						"seclogic.io/workload-namespace":        "default",
						"seclogic.io/workload-kind":             "Deployment",
						"seclogic.io/workload-name":             "nginx-deployment",
						"seclogic.io/workload-resource-version": "339815",
					},
				},
			...
			expectedNetworkNeighbors: &v1beta1.NetworkNeighbors{
				...
				ObjectMeta: metav1.ObjectMeta{
					...
					Labels: map[string]string{
						"seclogic.io/workload-api-group":        "apps",
						"seclogic.io/workload-api-version":      "v1",
						"seclogic.io/workload-namespace":        "kube-system",
						"seclogic.io/workload-kind":             "DaemonSet",
						"seclogic.io/workload-name":             "fluentd-elasticsearch",
						"seclogic.io/workload-resource-version": "266406",
					},
				},
				Spec: v1beta1.NetworkNeighborsSpec{
					LabelSelector: metav1.LabelSelector{
		...
		},
		{
			...
			expectedNetworkNeighbors: &v1beta1.NetworkNeighbors{
				...
				ObjectMeta: metav1.ObjectMeta{
					...
					Namespace: "default",
					Labels: map[string]string{
						"seclogic.io/workload-api-group":        "",
						"seclogic.io/workload-api-version":      "v1",
						"seclogic.io/workload-namespace":        "default",
						"seclogic.io/workload-kind":             "Pod",
						"seclogic.io/workload-name":             "nginx-deployment-fcc867f7-dgjrg",
						"seclogic.io/workload-resource-version": "339809",
					},
				},
				Spec: v1beta1.NetworkNeighborsSpec{
					LabelSelector: metav1.LabelSelector{
